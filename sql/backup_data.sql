...
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 62, N'7. Графики значений газоочисток 3,4 | Charts of gas cleaner 3,4', N'http://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fWater+supply%2fWater_supply_tables_gas_filter_BF&rs:Command=Render', N'node', 42, 62)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
...
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 139, N'Отчет МНЛЗ', N'http://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fSteelmaking%2f%d0%9e%d1%82%d1%87%d0%b5%d1%82+%d0%9c%d0%9d%d0%9b%d0%97+%d0%be%d0%b1%d1%89%d0%b8%d0%b9&rs:Command=Render', N'node', 77, 139)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
...
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 160, N'Почасовой балансовый отчет по О2', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fEnergy%2fgcCommonBalanceOxy&rs:Command=Render', N'node', 159, 173)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 161, N'Почасовой отчет по ПРВ', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fEnergy%2fgcCommonReport&rs:Command=Render', N'node', 159, 201)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
...
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 168, N'Почасовый отчет по сж. воздуху | Hourly air balance', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fEnergy%2fgcCommonBalanceAir&rs:Command=Render', N'node', 159, 199)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 169, N'Почасовый отчет по азоту | Hourly nitrogen balance', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fEnergy%2fgcCommonBalanceNitro&rs:Command=Render', N'node', 159, 200)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
...
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 173, N'Распределение О2 | O2 distribution', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fEnergy%2fgcCurrOxy&rs:Command=Render', N'node', 159, 160)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
...
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 196, N'Распределение технол.О2 | Technol. O2 distribution', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fEnergy%2fgcCurrOxy_technologic&rs:Command=Render', N'node', 159, 168)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
...
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 200, N'Распределение технич.О2 | Technical O2 distribution', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fEnergy%2fgcCurrOxy_technic&rs:Command=Render', N'node', 159, 161)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 201, N'Почасовой отчет по параметрам О2', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fEnergy%2fgcCommonParamsOxy&rs:Command=Render', N'node', 159, 196)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 202, N'Средний вес налива ковшей по ДЦ-1 и ДЦ-2', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fSinter+and+Blast%2f%d0%a1%d1%80%d0%b5%d0%b4%d0%bd%d0%b8%d0%b9+%d0%b2%d0%b5%d1%81+%d0%bd%d0%b0%d0%bb%d0%b8%d0%b2%d0%b0+%d0%ba%d0%be%d0%b2%d1%88%d0%b5%d0%b9+%d0%bf%d0%be+%d0%94%d0%a6&rs:Command=Render', N'node', 32, NULL)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 203, N'Оборачиваемость ковшей по ДЦ-1,2 (посуточно) | Tturnover ladles of BF shop 1,2 ', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fSinter+and+Blast%2f%d0%9e%d0%b1%d0%be%d1%80%d0%b0%d1%87%d0%b8%d0%b2%d0%b0%d0%b5%d0%bc%d0%be%d1%81%d1%82%d1%8c+%d0%ba%d0%be%d0%b2%d1%88%d0%b5%d0%b9+%d0%bf%d0%be+%d0%94%d0%a6&rs:Command=Render', N'node', 32, NULL)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 204, N'Отчет по расходу энергоресурсов в КЦ | Energy consumption', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fSteelmaking%2fEnergy+consumption&rs:Command=Render', N'node', 36, NULL)
insert into [KRR-PA-GLB-SERVICE].[dbo].visualization_menu 
( [id], [name], [link], [type], [parent], [sortid] )
values( 205, N'Доменный газ | Blast Furnace Gas', N'https://krr-sql-paclx02.europe.mittalco.com/ReportServer_PACLX02/Pages/ReportViewer.aspx?%2fProductivity%2fSinter+and+Blast%2fBF_Gas_hour&rs:Command=Render', N'node', 184, NULL)
